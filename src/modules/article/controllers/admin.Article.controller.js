...
export const create = async (req, res) => {
  try {
    ...
    res.status(201).json({ success: true, redirectTo: "/admin/article", message: "Created successfully" });
  } catch (err) {
    console.log(err)
...
export const update = async (req, res) => {
  try {
    ...
    res.status(200).json({ success: true, data, redirectTo: `/admin/article/${req.params.id}`, message: "Updated successfully" });
  } catch (err) {
    console.log(err)
    res.status(500).json({ error: err });
  }
...
export const destroy = async (req, res) => {
  try {
    ...
    res.status(200).json({ success: true, message: 'Deleted successfully', redirectTo: "/admin/article" });
  } catch (err) {
    console.log(err)
    res.status(500).json({ error: err });
  }
